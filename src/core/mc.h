...
extern mc_pred_func_t  mc_pred_16xh_c[4];
extern mc_pred_func_t  mc_pred_8xh_c[4];
extern mc_bidir_func_t mc_bidir_16xh_c[16];
extern mc_bidir_func_t mc_bidir_8xh_c[16];

extern mc_pred_func_t  mc_pred_16xh_nsse2[4];
