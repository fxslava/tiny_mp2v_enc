...
MP2V_INLINE void scan_dequant_idct_template_sse2(pixel_t* plane, uint32_t stride, int16_t QF[64], uint16_t W[64], uint8_t quantizer_scale, int intra_dc_precision) {
    __m128i buffer[8];
    for (int i = 0; i < 8; i++)
